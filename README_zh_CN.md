...
一个强大的思源笔记插件，让你的引述块焕然一新！将普通引述块转换为美观、实用的 Callout 提示块，功能丰富、高度可定制。
...
- 📋 **大纲支持** - Callout 内容在侧边栏大纲面板中显示，快速导航定位
...
### 批量转换
在普通引述块第一行添加命令（如 `info`），即可转换为 Callout。
